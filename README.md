...
- **Community events**: a public events calendar at `/community/events` — reviewers and admins post events directly, signed-in users submit events into a moderation queue at `/admin/events`; submitters can edit their events, with regular-user edits going back through review
